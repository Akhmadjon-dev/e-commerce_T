      ...
      <div className="main">
        <div className="aside">
          <div className="text">
            <p>
              Номер заказа:{" "}
              <pre style={{ color: "#00AC4E" }}>Заказ №2334678954</pre>
            </p>
            <p>
              Способ оплаты:<span>Банковская карта</span>
            </p>
            <p>
              Дата заказа:<span>19.05.2020</span>
            </p>
            <p>
              Дата доставки:<span>23.05.2020</span>
            </p>
            <p>
              Статус заказа:<pre style={{ color: "#00AC4E" }}>Доставлен</pre>
            </p>
          </div>
          <div>
            {context.map((item) => (
        ...
        <div className="article">
          <div className="text">
            ...
            <p>
              Статус заказа:<pre style={{ color: "red" }}>Отменен</pre>
            </p>
          </div>
          <div>
            <div className="box">
