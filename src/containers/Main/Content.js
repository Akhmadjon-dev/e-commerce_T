...
export default class Content extends Component {
    ...
    render() {
        ...
        return (
            <ContentApp>
                {isShow && (<Reviews closeHandler={this.modalHandler} />)}
                <article>
                    <div className='img'>
                        <img src={img} alt='' />
                    </div>
                    <div className='sell'>
                        ...
                        <div className='price'>
                            ...
                            <button className='price__button'><RiShoppingCartLine /></button>
                        </div>
                    </div>
                </article>
                <aside>
                    <div className='params'>
                        <div className='links'>
                            <Link className='link' to='/about-product'>О товаре</Link>
                            <Link className='link'>Параметры</Link>
                            <p className='link' onClick={this.modalHandler}>Отзывы</p>
                        </div>
